...
const generateProjects = projectsArr => {
    ...
    const featuredProjectHtmlArr = featuredProjects.map(({
        ...
        return `
            <div class="col-12 mb-2 bg-dark text-light p-3 flex-column">
                ...
                <p>${description}</p>
                <a href="${link}" class="btn mt-auto"><i class="fab fa-github mr-2"></i>View Projecto on GitHub</a>
            </div>
        `;
    });
    ...
    /* .filter() and .map() all chained together (basically generateProjects())
    const generateProjects = projectsArr => {
        return `
    ...
    */
    ...
    /* Replaced by featuredProjects and nonFeaturedProjects
    ...
    */
    ...
    /* replaced by the return below which includes featured & nonFeatured
    return `
    <section class="my-3" id="portfolio">
       <h2 class="text-dark bg-primary p-2 display-inline-block">Work</h2>
       <div class="flex-row justify-space-between">
        ...
        <body>
            <header>
                <div class="container flex-row justify-space-between align-center py-3">
                    ...
                    <nav class="flex-row">
                        <a class="ml-2 my-1 py-1 bg-secondary text-dark"
